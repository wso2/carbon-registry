...
public class RegistryChildNodeJoinCondition implements ChildNodeJoinCondition {
    ...
    public RegistryChildNodeJoinCondition(String childSelName, String parentSelName) {

        this.childSelName = childSelName;
        this.parentSelName = parentSelName;
