...
<script type="text/javascript"	src="../registry_vault/js/properties.js"></script>
<script src="../ajax/js/prototype.js" type="text/javascript"/>

<%@ page import="org.wso2.carbon.registry.common.ui.UIConstants"%>
<%@ page import="org.wso2.carbon.registry.security.vault.ui.*"%>
...
<link rel="stylesheet" type="text/css" 	href="../registry_vault/css/secureVault.css">

<carbon:jsi18n
		resourceBundle="org.wso2.carbon.registry.security.vault.ui.i18n.JSResources"
		request="<%=request%>" namespace="org.wso2.carbon.registry.secure.vault.ui" />
...
<%
	...
	try {
		org.wso2.carbon.registry.security.vault.ui.PropertiesServiceClient client = new org.wso2.carbon.registry.security.vault.ui.PropertiesServiceClient(config,
		session);
...
<fmt:bundle
	basename="org.wso2.carbon.registry.security.vault.ui.i18n.Resources">
<div id="middle">
        <h2>
	...
	<div id="propertiesExpanded" style="display: ">
		...
		<div id="resourceProperties">
			<%@ include	file="../registry_vault/properties-ajaxprocessor.jsp"%>
		</div>
