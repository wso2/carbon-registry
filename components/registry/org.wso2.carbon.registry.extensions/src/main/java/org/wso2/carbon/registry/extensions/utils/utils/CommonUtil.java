...
public class CommonUtil {
    ...
    private static final Log log = LogFactory.getLog(org.wso2.carbon.registry.extensions.utils.CommonUtil.class);
    ...
    public static void addService(OMElement service, RequestContext context)throws RegistryException{
        ...
        String tempNamespace = org.wso2.carbon.registry.extensions.utils.CommonUtil.derivePathFragmentFromNamespace(
                org.wso2.carbon.registry.extensions.utils.CommonUtil.getServiceNamespace(service));
        String path = getChrootedServiceLocation(registry, context.getRegistryContext()) + tempNamespace + version +
                RegistryConstants.PATH_SEPARATOR + org.wso2.carbon.registry.extensions.utils.CommonUtil.getServiceName(service);
        ...
        boolean lockAlreadyAcquired = !org.wso2.carbon.registry.extensions.utils.CommonUtil.isUpdateLockAvailable();
...
//            We check for an existing resource and add its UUID here.
        ...
        registry.addAssociation(path,RegistryUtils.getAbsolutePath(registry.getRegistryContext(),
                org.wso2.carbon.registry.extensions.utils.CommonUtil.getDefinitionURL(service)), CommonConstants.DEPENDS);
        registry.addAssociation(RegistryUtils.getAbsolutePath(registry.getRegistryContext(),
                org.wso2.carbon.registry.extensions.utils.CommonUtil.getDefinitionURL(service)),path, CommonConstants.USED_BY);
    }
...
*/
     ...
     * @throws org.wso2.carbon.registry.core.exceptions.RegistryException throws if the operation failed
     */
/*
