...
public class PlainTextIndexerTest extends TestCase {
    ...
    public void testGetIndexedDocument() throws Exception {
        ...
        PlainTextIndexer textIndexer = new PlainTextIndexer();
        IndexDocument document = textIndexer.getIndexedDocument(fileData);
