...
public class MSExcelIndexerTest extends TestCase {
    private byte[] fileContent = null;
    private String mediaType = "application/xls";
    private int tenantID = -1234;
    private String tenantDomain = "carbon.super";

    public void setUp() throws Exception {
        Path resourcePath = IndexingTestUtils.getResourcePath("unit-test-sample.xls");
