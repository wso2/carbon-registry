...
public class CopyResourceUtil {
    ...
    private static final Log log = LogFactory.getLog(CopyResourceUtil.class);
    ...
    public static void copyResource(
        ...
        try {
            registry.copy(oldResourcePath, newResourcePath);

        } catch (RegistryException e) {
            String msg = "Failed to copy the resource: " + oldResourcePath + " to Destination: " +
                    newResourcePath + ". Caused by: " + ((e.getCause() instanceof SQLException) ?
                    "" : e.getMessage());
            log.error(msg, e);
