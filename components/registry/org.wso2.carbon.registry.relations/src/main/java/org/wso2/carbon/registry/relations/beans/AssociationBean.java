 ...
 * used as a argument/return type of a web services.
 */
public class AssociationBean {
    ...
    /**
     * Default constructor for the AssociationBean class. It just creates an empty association.
     */
     ...
     */
    public AssociationBean(String sourcePath, String destinationPath, String associationType) {
